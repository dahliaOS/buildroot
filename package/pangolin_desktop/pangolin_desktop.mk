...
define PANGOLIN_DESKTOP_BUILD_CMDS
	cd $(@D)&&rm -rf pangolin_desktop&&git clone https://github.com/dahliaOS/pangolin_desktop&&cd $(@D)/pangolin_desktop&&git submodule update --init --recursive &&ls&& cd backend &&git checkout main&&cd ../&&flutter build linux --release --verbose
...
define PANGOLIN_DESKTOP_INSTALL_TARGET_CMDS
	...
	cp -r $(@D)/pangolin_desktop/build/linux/x64/release/bundle/* $(TARGET_DIR)/dahlia/pangolin_desktop
endef
